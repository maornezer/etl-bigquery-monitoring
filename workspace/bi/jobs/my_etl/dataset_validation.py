...
python ./jobs/my_etl/dataset_validation.py my-bi-project-ppltx --etl-name dataset --etl-action daily --days-back 2
...
for dataset_name, tables_conf in etl_configuration.items():
    ...
    exclude_tables_list = tables_conf["exclude"]
    ...
    for table in tables:
        ...
        print(f"{table.project},{table.dataset_id},{table_name}")
...
if not df_alerts.empty:
    ...
    writeFile(logs_path / f"{etl_name}_alert_slack_msg.md", msg)
    print(msg)
